...
public partial class GetJPG : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      //  string srcImageUrl = "http://www.acems.tw:44459/image/8002-01.jpg";
        string srcImageUrl = "http://www2.acems.tw/API/CCTV/GetCamera/2";

        //儲存圖片在Server上
        //this.saveThumbPic(srcImageUrl, 1920, Server.MapPath("~/test2.jpg"));
        ...
        */
        ...
        //System.Drawing.Image img = System.Drawing.Image.FromFile(Server.MapPath("~/test2.jpg"));
