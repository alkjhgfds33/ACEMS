<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cctv_stno.aspx.cs" Inherits="cctv_stno" %>
    ...
    <form id="form1" runat="server">
       <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 bg-info" style="padding:0px;">
                    <p class="text-light text-center" style="background-color:black; height:30px; line-height:30px; margin:0px;">
                    <asp:Label ID="lblTitle5" runat="server" Text=""></asp:Label></p>                    
                    <asp:ImageButton  id="ccdImage5" src="images/loading2.png" style="height:390px; width:100%;"  
                        runat="server" AutoPostBack="True"  ImageAlign="Bottom" ImageUrl="~/img/plus.png" 
                        OnClientClick="Navigate(5)" OnClick="s"  />
                </div>

                <div class="col-sm-12 col-md-12 col-lg-6 bg-info" style="padding:0px;">
                    <p class="text-light text-center" style="background-color:black; height:30px; line-height:30px; margin:0px;">
                    <asp:Label ID="lblTitle6" runat="server" Text=""></asp:Label></p>
                    <asp:ImageButton  id="ccdImage6" src="images/loading2.png" style="height:390px; width:100%;"  
                        runat="server" AutoPostBack="True"  ImageAlign="Bottom" ImageUrl="~/img/plus.png" 
                        OnClientClick="Navigate(6)" OnClick="s"  />
                </div>
            </div>
